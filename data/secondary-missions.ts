...
const secondaryMissions: selectOption[] = [
  {
    Label: "Secure No Man’s Land",
    Value: "Secure No Man’s Land",
    Active: true,
  },
  {
    Label: "Capture Enemy Outpost",
    Value: "Capture Enemy Outpost",
    Active: true,
  },
  ...
  {
    Label: "Storm Hostile Objective",
    Value: "Storm Hostile Objective",
    Active: true,
  },
  {
    Label: "Engage on All Fronts",
    Value: "Engage on All Fronts",
    Active: true,
  },
  ...
  {
    Label: "Deploy Teleport Homer",
    Value: "Deploy Teleport Homer",
    Active: true,
  },
